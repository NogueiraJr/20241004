...
function TableListOperations(columns, filteredData: OperationType[], renderTabs: (actions: string[], record: OperationType) => React.JSX.Element[], action: string, expandedRowKeys: string[], handleExpand: (expanded: boolean, record: OperationType) => void) {
